...
public class GBP extends Thread implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
            ...
            public void run() {
                Platform.runLater(() -> {
                    ...
                    try {
                        ...
                        ResultSet resultSet = statement.executeQuery("SELECT Time, GBP FROM book1");
        ...
        button60S.setOnMouseEntered(e -> button60S.setStyle("-fx-background-color: #4a0178;-fx-background-radius: 50;"));
        button60S.setOnMouseExited(e -> button60S.setStyle("-fx-background-color:  #8c00ff;-fx-background-radius: 50;"));
        button1H.setOnMouseEntered(e -> button1H.setStyle("-fx-background-color: #4a0178;-fx-background-radius: 50;"));
        button1H.setOnMouseExited(e -> button1H.setStyle("-fx-background-color:   #8c00ff;-fx-background-radius: 50;"));
        button24H.setOnMouseEntered(e -> button24H.setStyle("-fx-background-color: #4a0178;-fx-background-radius: 50;"));
        button24H.setOnMouseExited(e -> button24H.setStyle("-fx-background-color:   #8c00ff;-fx-background-radius: 50;"));
        button7D.setOnMouseEntered(e -> button7D.setStyle("-fx-background-color: #4a0178;-fx-background-radius: 50;"));
        button7D.setOnMouseExited(e -> button7D.setStyle("-fx-background-color:   #8c00ff;-fx-background-radius: 50;"));
        button1M.setOnMouseEntered(e -> button1M.setStyle("-fx-background-color: #4a0178;-fx-background-radius: 50;"));
        button1M.setOnMouseExited(e -> button1M.setStyle("-fx-background-color:   #8c00ff;-fx-background-radius: 50;"));
        button1Y.setOnMouseEntered(e -> button1Y.setStyle("-fx-background-color: #4a0178;-fx-background-radius: 50;"));
        button1Y.setOnMouseExited(e -> button1Y.setStyle("-fx-background-color:   #8c00ff;-fx-background-radius: 50;"));
        ...
        button60S.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                AreaChartOf60S.getYAxis().setLabel("GBP Price");
        ...
        button1H.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                AreaChartOf1H.getYAxis().setLabel("GBP Price");
        ...
        button24H.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                AreaChartOf24H.getYAxis().setLabel("GBP Price");
        ...
        button7D.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                AreaChartOf7D.getYAxis().setLabel("GBP Price");
        ...
        button1M.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                AreaChartOf1M.getYAxis().setLabel("GBP Price");
        ...
        button1Y.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                AreaChartOf1Y.getYAxis().setLabel("GBP Price");
