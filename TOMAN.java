...
public class TOMAN extends Thread implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
            ...
            public void run() {
                Platform.runLater(() -> {
                    ...
                    try {
                        ...
                        ResultSet resultSet = statement.executeQuery("SELECT Time, TOMAN FROM book1");
                        ...
                        while (resultSet.next()) {
                            if (currentTime.equals(resultSet.getTime("Time").toString())) {
                                CurrentPrice.setText(resultSet.getString("TOMAN"));
                                sleep(1000);
                            }
                        }
                        resultSet.close();
                        ...
                        while (resultSet.next()) {
                            ...
                            if (currentTime.equals(resultSet.getTime("Time").toString())) {
                                while (!formattedNewTime.equals(resultSet.getTime("Time").toString())) {
                                    ...
                                    price += resultSet.getDouble("TOMAN");
                                    sleep(60000);
                                    resultSet.next();
                                }
                                price /= 60;
        ...
        button60S.setOnMouseEntered(e -> button60S.setStyle("-fx-background-color: #182e94;-fx-background-radius: 50;"));
        button60S.setOnMouseExited(e -> button60S.setStyle("-fx-background-color:  #2671b5;-fx-background-radius: 50;"));
        button1H.setOnMouseEntered(e -> button1H.setStyle("-fx-background-color: #182e94;-fx-background-radius: 50;"));
        button1H.setOnMouseExited(e -> button1H.setStyle("-fx-background-color:   #2671b5;-fx-background-radius: 50;"));
        button24H.setOnMouseEntered(e -> button24H.setStyle("-fx-background-color: #182e94;-fx-background-radius: 50;"));
        button24H.setOnMouseExited(e -> button24H.setStyle("-fx-background-color:   #2671b5;-fx-background-radius: 50;"));
        button7D.setOnMouseEntered(e -> button7D.setStyle("-fx-background-color: #182e94;-fx-background-radius: 50;"));
        button7D.setOnMouseExited(e -> button7D.setStyle("-fx-background-color:   #2671b5;-fx-background-radius: 50;"));
        button1M.setOnMouseEntered(e -> button1M.setStyle("-fx-background-color: #182e94;-fx-background-radius: 50;"));
        button1M.setOnMouseExited(e -> button1M.setStyle("-fx-background-color:   #2671b5;-fx-background-radius: 50;"));
        button1Y.setOnMouseEntered(e -> button1Y.setStyle("-fx-background-color: #182e94;-fx-background-radius: 50;"));
        button1Y.setOnMouseExited(e -> button1Y.setStyle("-fx-background-color:   #2671b5;-fx-background-radius: 50;"));
        ...
        button60S.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                AreaChartOf60S.getYAxis().setLabel("TOMAN Price");
        ...
        button1H.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                AreaChartOf1H.getYAxis().setLabel("TOMAN Price");
        ...
        button24H.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                AreaChartOf24H.getYAxis().setLabel("TOMAN Price");
        ...
        button7D.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                AreaChartOf7D.getYAxis().setLabel("TOMAN Price");
        ...
        button1M.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                AreaChartOf1M.getYAxis().setLabel("TOMAN Price");
        ...
        button1Y.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                AreaChartOf1Y.getYAxis().setLabel("TOMAN Price");
    ...
    private void fetchAndAddData60S() throws SQLException {
        try {
            ...
            while (resultSet.next()) {
                ...
                double price = resultSet.getDouble("TOMAN");
                if (now.format(dtf).equals(resultSet.getTime("TIME").toString())) {
                    for (int j = 0; j < 60; j++) {
                        dataSeries.getData().add(new XYChart.Data<>(j, resultSet.getDouble("TOMAN")));
